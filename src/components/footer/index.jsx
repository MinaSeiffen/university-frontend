...
function Footer() {
  return (
    <footer className="bg-[#240F6E] text-[#FFFFFF] font-[Inter] mt-20 ">
      <div className="mx-auto py-8 pt-20 pe-5">
        <div className="flex justify-between">
          <div className="mb-6 md:mb-0 w-90">
            <img src="/images/Frame 1.svg" className="h-[120px] me-3 -mt-[40px] ml-[88px]" alt="FlowBite Logo" />

            <p className="text-[16px] mt-10 mb-5 ml-[64px]">We help students find the right university in Russia.</p>
            <div className="flex text-[20px] ml-[90px]">
          ...
          <div>
            <h2 className="mb-6 text-[20px] font-semibold dark:text-white mr-[160px]">Legal</h2>
            <ul className="dark:text-gray-400 font-medium">
              <li className="mb-4">
        ...
        <div className='flex mt-20'>
          ...
          <img className="ml-[273px] -mt-[24px]" src="/images/bicycle (1) 1.svg" alt="la_university" />

          <img className="ml-[794px]" src="/images/la_university.svg" alt="la_university" />

          <img className="ml-[43px]" src="/images/icon-park-outline_tree-two.svg " alt="la_university" />

        </div>
        <hr className="ml-[10px] -mt-[12px] w-full" />
      </div>
    </footer>
  );
};
