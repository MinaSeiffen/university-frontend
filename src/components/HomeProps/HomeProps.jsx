...
const HomeProps = ({ image, titel, description, image2, titel2, description2 }) => {
  return (
    <>
      {/* image 1 and text */}
      <div className="flex mt-[25px] mb-[100px] w-[1186px] h-[378.57px] flex-row gap-[27px] xl:ml-[8%] 2xl:mx-[11.3%] 3xl:mx-[16.3%] 4xl:mx-[19%] font-[Merriweather]">
      ...
      {/* image 2 and text */}
      <div className="flex mt-[25px] mb-[130px] w-[1186px] h-[378.57px] flex-row gap-[27px] xl:ml-[8%] 2xl:mx-[11.3%] 3xl:mx-[16.3%] 4xl:mx-[19%] font-[Merriweather]">
