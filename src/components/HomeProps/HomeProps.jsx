...
const HomeProps = ({ image, titel, description, image2, titel2, description2 }) => {
  return (
    <>
      {/* image 1 and text */}
      <div className="flex mt-[25px] mb-[100px] w-[1186px] h-[378.57px] flex-row gap-[27px] xl:ml-[8%] 2xl:ml-[18.5%] font-[Merriweather]">
      ...
      {/* image 2 and text */}
      <div className="flex mt-[25px] mb-[130px] w-[1186px] h-[378.57px] flex-row gap-[27px] xl:ml-[8%] 2xl:ml-[18.5%] font-[Merriweather]">
