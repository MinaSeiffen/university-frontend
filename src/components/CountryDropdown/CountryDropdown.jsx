...
const CountryDropdown = ({ selectedCountry, setSelectedCountry }) => {
  ...
  return (
    <div className="absolute w-[122px] h-[56px]" ref={dropdownRef}>
      <button
        onClick={toggleDropdown}
        className="w-[122px] h-[56px] rounded-[10px] flex items-center justify-between bg-white border border-[#212121] px-4 py-4 pl-[16px] shadow leading-tight"
      >
