  ...
  return (
    <nav className="absolute w-full bg-border-gray-200 dark:bg-[#212121] z-10 top-0">
      <div className="max-w-screen-x1 flex flex-wrap justify-between items-center mx-auto md:max-w-6xl">
        ...
        <div
          className={`w-full md:flex md:items-center md:w-auto font-[merriweather] ${
            isMenuOpen ? "" : "hidden"
          }`}
          id="navbar-default"
        >
          <ul className="font-medium flex flex-col text-[20px] md:flex-row md:items-center md:space-x-8 p-4 md:p-0 md:mt-0 rounded-lg dark:bg-gray-800 md:dark:bg-[#212121]">
            <li>
              <NavLink
                to="/"
                className={`block py-2 px-3 rounded hover:bg-[#240F6E] md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 ${
                  isRootPath ? "text-white" : "text-[#212121]"
                }`}
              >
                Home
              </NavLink>
