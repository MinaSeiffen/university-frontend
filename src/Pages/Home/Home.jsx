...
export default function Home() {
  ...
  return (
    <>
      ...
      <div className="font-[Merriweather] lg:mt-[100px] xl:mx-[7.8%] 2xl:mx-[11.3%] 3xl:mx-[15.3%] 4xl:mx-[19%] ">  {/* Add padding for content */}
      ...
      <div className="py-[8px] mt-[56px] w-[482px] h-[56px] xl:ml-[7.8%] 2xl:mx-[11.3%] 3xl:mx-[15.3%] 4xl:mx-[19%] "> {/* Add padding for content */}
      ...
      <h2 className="w-[467px] h-[40px] font-merriweather font-normal text-[32px] leading-[40.22px] text-[#240F6E] xl:ml-[7.8%] 2xl:mx-[11.3%] 3xl:mx-[15.3%] 4xl:mx-[19%] -mt-[30px]">  {/* Adjust spacing for different screen sizes */}
